...
namespace DevzUniversity.Controllers
{
    public class StudentController : Controller
    {
        ...
        */
        ...
        {
            ViewBag.CurrentSort = sortOrder; //for paging (pagedList)
            ...
            //return View(students.ToList()); --awal sebelum ada paging
        ...
        public ActionResult Create([Bind(Include = "LastName,FirstMidName,EnrollmentDate,Email,PhoneNo")] Student student)
        {
            try
            {
